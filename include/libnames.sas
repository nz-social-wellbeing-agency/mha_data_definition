...
DESCRIPTION: Set up all the relevant schemas from the
IDI clean and IDI sandpit area

INPUT: 
NA

OUTPUT:
See below for libnames
...
/*libname cen1 ODBC dsn=idi_clean_20160715_srvprd schema=cen_clean;*/
...
/*NZTA*/
libname nzta ODBC dsn=idi_clean_archive_srvprd schema=nzta_clean;
